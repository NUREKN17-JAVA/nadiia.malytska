...
public class MainFrameTest extends JFCTestCase {
    ...
    public void testAddUserOk() {
        try {
            ...
            SystemUser user = new SystemUser(firstName, lastName, now);

            SystemUser expectedUser = new SystemUser(1L, firstName, lastName,
                    now);
    ...
    public void testCancelAddUser() {
        try {
            ...
            ArrayList<SystemUser> users = new ArrayList<>(this.users);
            mockUserDao.expectAndReturn("findAll", users);
