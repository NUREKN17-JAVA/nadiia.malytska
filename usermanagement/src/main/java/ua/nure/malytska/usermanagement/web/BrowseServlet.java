...
public class BrowseServlet extends HttpServlet {
    ...
    private void details(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            SystemUser user = (SystemUser) DAOFactory.getInstance().getUserDao()
                    .find(new Long(idStr));
    ...
    private void delete(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            DAO<SystemUser> userDao = DAOFactory.getInstance().getUserDao();
            SystemUser user = (SystemUser) userDao.find(new Long(idStr));
            userDao.delete(user);
